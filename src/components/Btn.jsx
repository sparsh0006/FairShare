...
export default function({ loading, text = '', className = '', onClick = () => {}, loadingClass = '' }) {
    return (
        ...
        <button className={clsx('w-full h-[54px] bg-Orange rounded-[8px] mt-[14px] text-White text-h6 font-semibold flex justify-center items-center active:opacity-70', className, {'opacity-70': false})} onClick={onClick}>
            <span>{text}</span>
